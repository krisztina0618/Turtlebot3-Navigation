...
"""autogenerated by genpy from tb3_projet_LAKHAL_MEZOUAR/MoveActionFeedback.msg. Do not edit."""
import sys
...
class MoveActionFeedback(genpy.Message):
  _md5sum = "337a8b103a13a9377ab9e7c43e2028e3"
  _type = "tb3_projet_LAKHAL_MEZOUAR/MoveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','tb3_projet_LAKHAL_MEZOUAR/MoveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = tb3_projet_LAKHAL_MEZOUAR.msg.MoveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = tb3_projet_LAKHAL_MEZOUAR.msg.MoveFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.feedback.pos_x_intermediaire))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.pos_x_intermediaire,) = _get_struct_f().unpack(str[start:end])
      return self
